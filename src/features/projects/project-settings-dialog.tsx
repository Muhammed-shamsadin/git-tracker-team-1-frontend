    ...
    if (open) {
      ...
      if (!currentProject?._id && id) {
        fetchProjectById(id as string).catch((e) =>
          console.error("Failed to fetch project for settings dialog", e)
        );
      }
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <ConfirmationDialog
                    ...
                    description="Are you sure you want to delete (archive) this project? It will be moved to the Recycle Bin and can be restored later."
