  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">
            ...
            {user?.userType === "client" && "Manage and monitor your projects"}
      ...
      <ConfirmationDialog
        ...
        description={`Are you sure you want to delete (archive) the project "${projectToDelete?.name}"? The project will be moved to the Recycle Bin and can be restored later.`}
